...
class Model(nn.Module):
    def __init__(self):
        ...
        model = timm.create_model('convnext_xlarge', pretrained=False, num_classes=2)
        
        # 加载本地预训练权重（ImageNet 1000类）
        local_weights_path = "/root/autodl-tmp/convnext_xlarge/model.safetensors"
