...
#%%
data_list = sorted(glob.glob('/root/autodl-tmp/Old-LIDC-IDRI/LIDC-IDRI*'))
data_num = len(data_list)
# print(f"找到{len(data_list)}个数据文件夹")
nodule_info = []

block_size = [64,64,56]

save_path_p = '/root/autodl-tmp/npy64/'
#%%
k = 0
...
nodule_info_csv.to_csv('/root/autodl-tmp/nodule_info64.csv')
